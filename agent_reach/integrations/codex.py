...
def _documentation_summary() -> list[str]:
    return [
        ...
        "Treat `engagement`, `media_references`, `identifiers`, `extras.source_hints`, `error.category`, social time-window warnings, and web extraction hygiene metadata as diagnostics only, not ranking or trust scores.",
